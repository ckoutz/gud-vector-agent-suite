...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("transport", "external_endpoint_id", name=op.f("uq_owner_channel_endpoints_transport")),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["endpoint_id"], ["owner_channel_endpoints.id"], name=op.f("fk_conversations_endpoint_id_owner_channel_endpoints"), ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_conversations")),
        sa.UniqueConstraint("business_id", "external_conversation_id", name=op.f("uq_conversations_business_id")),
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint("business_id", "message_key", name=op.f("uq_inbound_messages_business_id")),
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["conversation_id"], ["conversations.id"], name=op.f("fk_outbound_messages_conversation_id_conversations"), ondelete="CASCADE"),
        sa.ForeignKeyConstraint(["inbound_message_id"], ["inbound_messages.id"], name=op.f("fk_outbound_messages_inbound_message_id_inbound_messages"), ondelete="SET NULL"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["inbound_message_id"], ["inbound_messages.id"], name=op.f("fk_workflow_runs_inbound_message_id_inbound_messages"), ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_workflow_runs")),
        sa.UniqueConstraint("inbound_message_id", "intent", name=op.f("uq_workflow_runs_inbound_message_id")),
    )
